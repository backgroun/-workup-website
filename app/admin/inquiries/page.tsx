...
const TYPE_BADGE: Record<string, string> = { franchise: "bg-[#303236] text-white", wholesale: "bg-[#2d4f72] text-white", support: "bg-[#E5541B] text-white", product: "bg-emerald-600 text-white" };
