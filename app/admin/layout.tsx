    ...
    <div className="min-h-screen bg-[#f1f5f9] flex flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto bg-[#f1f5f9]">
          <style>{`
            .ac .text-\\[9px\\]  { font-size: 10px !important; }
            .ac .text-\\[10px\\] { font-size: 11px !important; }
            .ac .text-\\[11px\\] { font-size: 12px !important; }
            .ac .text-\\[12px\\], .ac .text-xs   { font-size: 14px !important; }
            .ac .text-\\[13px\\] { font-size: 14px !important; }
            .ac .text-\\[14px\\], .ac .text-sm   { font-size: 16px !important; }
            .ac .text-\\[15px\\] { font-size: 17px !important; }
            .ac .text-\\[16px\\], .ac .text-base { font-size: 18px !important; }
            .ac .text-\\[18px\\], .ac .text-lg   { font-size: 20px !important; }
            .ac .text-\\[20px\\], .ac .text-xl   { font-size: 22px !important; }
            .ac .text-2xl  { font-size: 27px !important; }
            .ac .text-3xl  { font-size: 34px !important; }
            .ac .text-4xl  { font-size: 40px !important; }
            .ac .text-5xl  { font-size: 54px !important; }
            .ac { font-size: 18px; }
          `}</style>
