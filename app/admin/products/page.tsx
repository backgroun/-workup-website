...
export default function AdminProductsPage() {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* ── 브랜드/제조사 빠른 링크 ───────────────────────────────────────── */}
      <div className="flex items-center gap-3 py-3 px-5 bg-white border border-gray-200 rounded-xl shadow-sm">
        <span className="text-[13px] font-semibold text-gray-400 mr-1">관련 관리</span>
        <Link href="/admin/brands"
          className="flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-gray-700 border border-gray-200 rounded-lg hover:border-[#1A2B4A] hover:text-[#1A2B4A] transition-colors">
          <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
          </svg>
          브랜드 / 제조사
