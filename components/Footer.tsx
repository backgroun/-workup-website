    ...
    <footer className="bg-white border-t border-gray-200">
      ...
      <div className="border-b border-gray-100">
        <div className="px-[15px] md:px-[70px] py-4 flex flex-col md:flex-row md:items-center md:justify-between gap-2">
          ...
          <div className="flex items-center gap-x-4 md:gap-x-7">
            ...
            <Link href="#" className="text-[11px] md:text-[12px] text-gray-600 hover:text-[#1A2B4A] transition-colors whitespace-nowrap">
              이용약관
            </Link>
            <Link href="#" className="text-[11px] md:text-[12px] font-bold text-gray-800 hover:text-[#1A2B4A] transition-colors whitespace-nowrap">
              개인정보처리방침
            </Link>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-16">
          ...
          <div className="flex flex-col">
            <div className="text-[12px] text-gray-500 leading-[1.9]">
              <p>상호명 : (주)트레이딩포스트</p>
              <p>대표 : 방교환</p>
              <p>주소 : 경기도 포천시 호국로 56</p>
              <p>사업자등록번호 : 206-86-40318</p>
              <p>통신판매업 신고번호 : 제 2021-경기포천-0336</p>
            </div>
            <Link href="/admin"
          ...
          <div>
            ...
            <p className="text-[22px] font-bold text-[#1A2B4A] mb-3">070-4680-0064</p>
            <div className="text-[12px] text-gray-500 leading-[1.9]">
              <p>평일 09:00 ~ 20:00</p>
              <p>주말 10:00 ~ 20:00</p>
            </div>
      ...
      <div className="md:hidden px-[15px] py-8">
        ...
        <nav className="flex flex-col gap-4 mb-6">
          {navLinks.map((item) => (
            <Link key={item.label} href={item.href}
              className="text-[14px] text-[#1A2B4A]">
              {item.label}
            </Link>
          ))}
        </nav>
        ...
        <div className="border-t border-gray-200">
          ...
          {bizOpen && (
            <div className="pb-6">
              {/* 사업자 정보 */}
              <div className="text-[12px] text-gray-500 leading-[2] mb-3">
                <p>상호명 : (주)트레이딩포스트</p>
                <p>대표 : 방교환</p>
                <p>주소 : 경기도 포천시 호국로 56</p>
                <p>사업자등록번호 : 206-86-40318</p>
              ...
              <div className="flex items-center gap-5 mb-5">
                {socialIcons.map(({ label, href, icon }) => (
                  <a key={label} href={href} aria-label={label} className="text-gray-500">
                    {icon}
                  </a>
                ))}
              </div>
              ...
              <div className="text-[12px] text-gray-500 leading-[1.9]">
                <p className="font-semibold text-[#1A2B4A] text-[13px] mb-1">
                  고객센터 <span className="font-bold">070-4680-0064</span>
                </p>
                <p>평일 09:00 ~ 20:00</p>
                <p>주말 10:00 ~ 20:00</p>
              </div>
      ...
      <div className="border-t border-gray-100 px-[15px] md:px-[70px] py-4">
        <p className="text-[11px] text-gray-400">
          © 2026 (주)트레이딩포스트. All rights reserved.
        </p>
      </div>
