        ...
        <div className="flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-4 flex-shrink-0">
            ...
            <button
              ...
              aria-label="찜 목록"
            >
              <svg className="w-5 h-5" fill={count > 0 ? "#ff550c" : "none"} stroke={count > 0 ? "#ff550c" : "currentColor"} viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8}
                  d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />
              </svg>
              {count > 0 && (
                <span className="absolute inset-0 flex items-center justify-center pt-[3px] text-white text-[9px] font-bold leading-none pointer-events-none">
                  {count}
                </span>
              )}
            </button>
