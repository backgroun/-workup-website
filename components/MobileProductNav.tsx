  ...
  return (
    <div className="md:hidden sticky z-50 bg-white border-b border-gray-200 flex items-center justify-between px-5 h-12" style={{ top: "var(--wu-topbar-h, 36px)" }}>
      <div className="flex items-center gap-5">
        ...
        <Link href="/" aria-label="홈" className="text-gray-700 hover:text-[#303236] transition-colors">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="flex items-center gap-5">
        <Link href="/products" aria-label="제품 검색" className="text-gray-700 hover:text-[#303236] transition-colors">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
