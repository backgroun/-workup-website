    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50" onClick={onClose}>
      <div className="bg-white w-full max-w-md max-h-[90vh] overflow-y-auto rounded-lg" onClick={(e) => e.stopPropagation()}>
        <div className="p-6 md:p-8">
            ...
            <div className="flex items-center gap-3">
              <div className="w-14 h-14 bg-[#f4f4f4] rounded overflow-hidden flex-shrink-0">
                {product.imageUrl && (
                  ...
                  <img src={ikResize(product.imageUrl, 112)} alt={product.name} loading="lazy" className="w-full h-full object-cover" />
                )}
              </div>
          ...
          {/* 문의글 제목 */}
          <div className="mb-3">
            <label className="block text-sm font-bold text-[#303236] mb-2">문의글 제목 <span className="text-[#E5541B]">*</span></label>
          ...
          {/* 내용 */}
          <div className="mb-5">
            <label className="block text-sm font-bold text-[#303236] mb-2">내용 <span className="text-[#E5541B]">*</span></label>
