...
function KakaoDirBtn({ store, userCoords: passedCoords }: {
  ...
  return (
    <button
      onClick={handleClick}
      disabled={loading}
      className="flex items-center gap-1.5 bg-[#ff550c] text-white text-xs px-3 py-2 hover:bg-[#d08a00] transition-colors disabled:opacity-60"
    >
      <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
          d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />
      </svg>
      {loading ? "위치 확인 중..." : "카카오맵 길찾기"}
    </button>
  );
}
                    ...
                    <div className="border-t border-gray-100 px-4 py-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        <a
                          ...
                          className="flex items-center gap-1.5 bg-[#1A2B4A] text-white text-xs px-3 py-2 hover:bg-[#243d5e] transition-colors"
                        >
                          <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                          </svg>
