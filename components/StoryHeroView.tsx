  ...
  return (
    ...
    >
      {hero.image_url && (
        ...
        <img src={ikResize(hero.image_url, 1920, 85)} alt={hero.heading || "WORKUP STORY"} loading="eager" fetchPriority="high" className="absolute inset-0 w-full h-full object-cover" />
      )}
