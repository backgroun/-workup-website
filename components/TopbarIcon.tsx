...
import type { TopbarIconName } from "@/lib/topbar";

// 탑바용 아이콘(스트로크 기반, currentColor 상속).
// 순수 표현 컴포넌트 — 훅 없음 → 서버/클라이언트 양쪽에서 사용 가능.
// SVG 경로만 저장하므로 사용자가 임의 마크업을 넣을 수 없다(XSS 방지).

const PATHS: Record<Exclude<TopbarIconName, "none" | "instagram">, string> = {
  phone:
  ...
  navigation:
    "M6 12 3.269 3.125A59.769 59.769 0 0121.485 12 59.768 59.768 0 013.27 20.875L5.999 12zm0 0h7.5",
  catalog:
  ...
  sparkle:
    "M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715 18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456z",
  truck:
