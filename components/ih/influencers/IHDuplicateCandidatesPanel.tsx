  ...
  return (
    <div className="rounded-lg border border-amber-200 bg-amber-50 mb-3">
      <div className="px-4 py-2.5 border-b border-amber-200/70">
        <h2 className="text-[14.5px] font-bold text-amber-800">중복 검수 필요 {items.length}건</h2>
      </div>
          ...
          <div key={c.id} className="flex items-center justify-between gap-3 px-4 py-3">
            ...
            <div className="flex-shrink-0 flex items-center gap-1.5">
              <button
                ...
                className="rounded-md bg-slate-900 text-white text-[13px] font-semibold px-3 py-1.5 disabled:opacity-40"
              >
                동일 인물
              </button>
              <button
                ...
                className="rounded-md border border-slate-300 text-slate-700 text-[13px] font-semibold px-3 py-1.5 disabled:opacity-40"
              >
                다른 인물
              </button>
            </div>
