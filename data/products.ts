...
export const products: Product[] = [
  {
    ...
    isNew: true,
    name: "스너그 부력보조복",
    tagline: "안전은 기본, 활동성까지 — 가볍게 즐기는 네오프렌 라이프베스트",
    price: "17,500원~",
    features: ["네오프렌 소재로 편안한 착용감", "3cm 부력재로 안정적인 부력", "2중 잠금장치 + 다리 고정끈"],
    featureTags: ["KC인증", "높은부력", "2중잠금", "네오프렌"],
    jobTypes: ["아웃도어"],
    jobSites: ["캠핑"],
    seasons: ["여름"],
    bg: "bg-[#3a4a42]",
    colors: [
      { name: "그레이", hex: "#5b5f63" },
      { name: "차콜그린", hex: "#4a5247" },
    ],
    sizes: ["M", "L", "XL", "2XL"],
    imageUrl: "https://res.cloudinary.com/dbwqhixrn/image/upload/v1782352579/workup/snug-vest_grey.png",
    subImages: [
      "https://res.cloudinary.com/dbwqhixrn/image/upload/v1782352580/workup/snug-vest_green.png",
      "https://res.cloudinary.com/dbwqhixrn/image/upload/v1782352581/workup/snug-vest_lifestyle-grey.jpg",
      "https://res.cloudinary.com/dbwqhixrn/image/upload/v1782352582/workup/snug-vest_lifestyle-green.jpg",
    ],
    coreValues: [
      "KC 인증을 획득한 신뢰할 수 있는 부력보조복",
      "3cm 부력재로 물 위에서 안정적인 부력 확보",
      "2중 잠금장치와 다리 고정끈으로 벗겨짐 걱정 없는 착용",
    ],
    recommendedFor: [
      "가족과 물놀이·해수욕을 즐기는 분",
      "낚시·카약 등 수상 레저를 즐기는 분",
      "캠핑·계곡 나들이가 잦은 분",
      "수영이 미숙해 안전이 걱정되는 분",
    ],
    keyFeatures: [
      { title: "네오프렌 소재", desc: "부드럽고 신축성 있는 네오프렌으로 몸에 착 감기는 편안한 착용감" },
      { title: "3cm 부력재", desc: "두툼한 3cm 부력재가 물 위에서 안정적인 부력을 제공합니다" },
      { title: "2중 안전잠금", desc: "지퍼와 버클 이중 잠금으로 격한 활동에도 풀리지 않습니다" },
      { title: "다리 고정끈", desc: "다리 고정끈이 조끼가 위로 말려 올라가는 것을 막아줍니다" },
    ],
    detailPoints: ["2중 안전잠금", "3cm 부력재", "다리 고정끈", "네오프렌 원단"],
    lifestyleScenes: [
      { tag: "WATER", title: "물에서", desc: "해수욕·계곡·수상레저에서 안정적인 부력으로 안전하게" },
      { tag: "LEISURE", title: "일상 레저", desc: "낚시·카약·캠핑까지, 가볍게 걸치는 활동성" },
    ],
    sizePrices: [
      { size: "M", weight: "40~60kg", price: "17,500원" },
      { size: "L", weight: "60~80kg", price: "18,500원" },
      { size: "XL", weight: "80~100kg", price: "19,500원" },
      { size: "2XL", weight: "100kg 이상", price: "21,500원" },
    ],
    fitNote: "적용 체중에 맞춰 사이즈를 선택하세요.",
    materialSpecs: [
      { label: "소재", value: "네오프렌" },
      { label: "부력재", value: "3cm" },
      { label: "잠금", value: "지퍼 + 버클 2중 잠금" },
      { label: "부가", value: "다리 고정끈" },
      { label: "인증", value: "KC인증 B021R021-18001" },
      { label: "제조사", value: "구름과환경" },
      { label: "색상", value: "그레이 · 차콜그린" },
    ],
    washCare: [
      { icon: "hand-wash", text: "민물로 손세척" },
      { icon: "no-dry", text: "건조기 사용 금지" },
      { icon: "no-bleach", text: "표백제 사용 금지" },
      { icon: "cold", text: "그늘에서 자연건조" },
    ],
    metaTitle: "스너그 부력보조복 — KC인증 네오프렌 라이프베스트 | WORKUP",
    metaDesc: "3cm 부력재, 2중 안전잠금, 다리 고정끈. KC인증 스너그 네오프렌 부력보조복. 그레이·차콜그린, M~2XL.",
  },
  {
