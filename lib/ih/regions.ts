// 대한민국 광역 시/도 — 활동지역 선택형 UI 공통 목록(등록 폼 · 목록 필터 · 모바일).
// 전국/서울/경기를 맨 앞에 고정하고, 나머지는 가나다순으로 정렬한다.
...
/** 시/도별 하위 시/군/구 — "전국"과 "세종"(단일 행정구역)은 하위 선택이 없다. */
export const SUB_REGIONS: Record<string, readonly string[]> = {
  서울: [
